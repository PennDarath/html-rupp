...
?>
    ...
    <section class="min-w-screen h-full">
        <div class=" flex h-full pt-12 min-w-screen gap-x-10 2xl:px-32 xl:px-28 lg:px-20 md:px-12 sm:px-5 px-5 sm:px-5 px-5">
            <div class="left flex  items-center justify-center">
                <div class="max-h-fit w-[80%] justify-center">
                    <img src="img/<?php echo $product['product_image']; ?>" alt="Avatar" class="h-[500px] w-fit">
                </div>
            </div>
  ...
  <div id="cart-drawer" class="hidden fixed inset-y-0 right-0 w-[30%] bg-white z-50 duration-300 shadow-lg rounded-l-lg">
    <div class="p-4">
          <div class="flex justify-start my-4">
            <button id="close-cart-drawer" class="px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400">Back</button>
        </div>
        <ul id="cart-items" class="divide-y divide-gray-200">
            ...
            <li class="py-2">
                ...
                <span><?php echo $product['phone_storage']; ?></span>
            </li>
            <li class="py-2">
