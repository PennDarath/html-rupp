              ...
              <tbody>
                <?php if ($result): ?>
                  <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                      <td class="cell"><?php echo $row['user_id']; ?></td>
                      <td class="cell"><span class="truncate"><?php echo $row['username']; ?></span></td>
                      <td class="cell"><?php echo $row['email']; ?></td>
					  <td>
						 <a class='btn btn-primary btn-sm' href='profile.php'>Edit</a>
						 
						 <form action="delete_user.php" method="post">
                        <input type="hidden" name="delete_user_id" value="USER_ID_HERE">
