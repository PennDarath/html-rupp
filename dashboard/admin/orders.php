<?php
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $tableRows .= '<td class="cell">' . $row['user_email'] . '</td>';
            $tableRows .= '<td class="cell">' . $row['product_id'] . '</td>';
            $tableRows .= '<td class="cell">' . $row['color'] . '</td>';
            $tableRows .= '<td class="cell">' . $row['quantity'] . '</td>';
            $tableRows .= '<td class="cell">' . $row['name'] . '</td>';
            $tableRows .= '<td class="cell">' . $row['phone_storage'] . '</td>';
			   $tableRows .= '<td class="cell"><a href="?delete_order=' . $row['order_id'] . '" onclick="return confirm(\'Are you sure you want to delete this order?\')">Delete</a></td>';
									...
									<table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Phone_storage</th>
											</tr>
										</thead>
										<tbody>
										<?php echo $tableRows; ?>
